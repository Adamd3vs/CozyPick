...
export class BoardArticleService {
 ...
 public async likeTargetBoardArticle(memberId: ObjectId, likeRefId: ObjectId): Promise<BoardArticle>{
    ...
    public async updateBoardArticleByAdmin(memberId: Schema.Types.ObjectId, input: BoardArticleUpdate): Promise<BoardArticle> {
        const { _id, articleStatus } = input;
...
public async removeBoardArticleByAdmin(memberId: ObjectId, articleId: string): Promise<BoardArticle>
 {
