...
// Ensure MemberUpdate._id is optional for delete operator compatibility
...
export class MemberResolver {
    ...
    @UseGuards(AuthGuard)
    @Mutation(()=> Member)
    public async updateAdminByAdmin(
        @Args("input") input: AdminUpdateByAdmin,
        @AuthMember('_id') memberId:ObjectId):Promise<Member>{
            
        return  await this.memberService.updateAdminByAdmin(memberId,input);
    }
    ...
    // accessToken: 15 min 
    // refreshToken: 7 days kop bulish kerak 
